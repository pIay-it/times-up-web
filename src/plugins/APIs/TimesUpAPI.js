...
export default {
    ...
    install: app => {
        ...
        app.config.globalProperties.$timesUpAPI.getImages = queryString => axios.get(`/images?${stringify(queryString)}`, { auth });
        ...
        app.config.globalProperties.$timesUpAPI.getGames = queryString => axios.get(`/games?${stringify(queryString)}`);
        ...
        app.config.globalProperties.$timesUpAPI.shuffleGameCards = gameId => axios.post(`/games/${gameId}/cards/shuffle`);
